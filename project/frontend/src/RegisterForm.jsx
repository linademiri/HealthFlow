...
import { NavLink, useNavigate } from 'react-router-dom';
import contactImage from './assets/R.jpeg';
import api from './api'; // Axios instance me baseURL
import { toast } from 'react-toastify';
import 'react-toastify/dist/ReactToastify.css';
            ...
            <div style={{
                ...
                <MDBCard className='p-3' style={{
                    ...
                    <MDBCardBody className='px-4 py-3'>
                        ...
                        <form onSubmit={handleRegister}>
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                                <MDBInput placeholder='Username' value={username} onChange={e => setUsername(e.target.value)} required />
                                <MDBInput placeholder='First Name' value={firstName} onChange={e => setFirstName(e.target.value)} required />
                                <MDBInput placeholder='Last Name' value={lastName} onChange={e => setLastName(e.target.value)} required />
                                <MDBInput placeholder='Email' type='email' value={email} onChange={e => setEmail(e.target.value)} required />
                                <MDBInput placeholder='Password' type='password' value={password} onChange={e => setPassword(e.target.value)} required />
                                <MDBInput placeholder='Confirm Password' type='password' value={confirmPassword} onChange={e => setConfirmPassword(e.target.value)} required />
                                <MDBInput placeholder='Date of Birth' type='date' value={dateOfBirth} onChange={e => setDateOfBirth(e.target.value)} required />
                                <MDBBtn type='submit' size='lg' style={{ width: '120px', alignSelf: 'center' }}>Register</MDBBtn>
                            </div>
                        </form>
                        <NavLink to="/login" className="text-center d-block mt-2" style={{ color: 'green', fontSize: '0.9rem' }}>
